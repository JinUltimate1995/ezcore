...
<!-- __ _ _ _ __| |_ (_)__ _____
  ...
  <head data-release=92b60e45 data-node="www09.us.archive.org">
    ...
    <meta name="baggage" content="sentry-trace_id=1a1aea68f29f41ac8e642ab774882fd5,sentry-sample_rate=0.001,sentry-transaction=%2Fdownload.php,sentry-public_key=94bf3037c1e245c8a927aaa4daad2dbb,sentry-environment=production,sentry-sampled=false,sentry-sample_rand=0.964916"/>    <meta name="sentry-trace" content="1a1aea68f29f41ac8e642ab774882fd5-0b4e5278ed8f4c58-0"/>
    <script  nonce="5207453f7e57cbb020065f12d34f15b8" >
 ...
 */
        ...
        <meta charset="UTF-8">
            ...
            <script src="//archive.org/includes/athena.js?v=92b60e45" type="text/javascript"></script>
    <script src="//archive.org/includes/apollo.js?v=92b60e45" type="text/javascript"></script>
    <script src="//archive.org/components/npm/lit/polyfill-support.js?v=92b60e45" type="text/javascript"></script>
    <script src="//archive.org/components/npm/@webcomponents/webcomponentsjs/webcomponents-bundle.js?v=92b60e45" type="text/javascript"></script>
<script nonce="5207453f7e57cbb020065f12d34f15b8" >
    ...
    </script>    <script src="//archive.org/includes/build/js/ia-topnav.min.js?v=92b60e45" type="text/javascript"></script>
    <script src="//archive.org/includes/build/js/archive.min.js?v=92b60e45" type="text/javascript"></script>
    <link href="//archive.org/includes/build/css/archive.min.css?v=92b60e45" rel="stylesheet" type="text/css"/>
              ...
              <nav class="media-menu-inner style-scope media-menu" aria-expanded="false">
                <div class="menu-group style-scope media-menu">
                  ...
                  <media-button class="style-scope media-menu x-scope media-button-1" data-mediatype="web"><!---->
                    ...
                    <a class="menu-item donate  style-scope media-button" href="/donate/?origin=iawww-mbhmbgrmenu"
            ...
            <login-button class="style-scope primary-nav x-scope login-button-1"><!---->
              <div class="logged-out-toolbar style-scope">
                ...
                <span class="style-scope login-button">
                  <a class="style-scope login-button" href="/signup">Sign up</a>
                  |
                ...
                <div class="icon-links style-scope media-subnav">
                  ...
                  <div class="links featured style-scope media-subnav">
                    ...
                    <li class="style-scope media-subnav"><a class="style-scope media-subnav" href="/details/booksbylanguage"
                        ...
                        Language</a></li>
                    <!----><!---->
                    <li class="style-scope media-subnav"><a class="style-scope media-subnav" href="/details/folkscanomy"
                      data-event-click-tracking="TopNav|FolkscanomyTexts"><!--?lit$49386103$-->Folkscanomy</a></li>
                    <!----><!---->
                    <li class="style-scope media-subnav"><a class="style-scope media-subnav" href="/details/government-documents"
      ...
      <nav class="initial style-scope signed-out-dropdown" aria-hidden="true">
        <ul class="style-scope signed-out-dropdown">
          ...
          <li class="style-scope signed-out-dropdown"><!--?lit$49386103$--><a class="style-scope signed-out-dropdown"
              href="/signup" tabindex="-1" data-event-click-tracking="TopNav|NavAvatarMenu-Signup">
              <!--?lit$49386103$-->
...
=========================================================
  0.0000   0.0000                                petabox start   petabox/www/sf/download.php:1:require
                                             |common/ia:66:require_once
                                             |setup.php:384:log
  0.0061   0.0061                             redis_read start   petabox/www/sf/download.php:79:main_wrap
                                             |download.php:98:main
                                             |download.php:304:quickFileRedir
                                             |download.php:1022:get_obj_fast
                                             |common/Metadata.inc:2625:_get_obj_fast
                                             |Metadata.inc:2688:run_l1_cache
                                             |Metadata.inc:1721:fetch
                                             ...
                                             |/petabox/www/common/Caching/TieredReactiveCache.inc:88:recompute_fn
                                             ...
                                             |/petabox/www/common/Cache.inc:387:recompute
                                             |Cache.inc:653:Metadata\L1\{closure}
  ...
  1.3603   1.3542                            redis_read finish   petabox/www/sf/download.php:79:main_wrap
                                             |download.php:98:main
                                             |download.php:304:quickFileRedir
                                             |download.php:1022:get_obj_fast
                                             |common/Metadata.inc:2625:_get_obj_fast
  ...
  4.7737   3.4134                          begin session_start   petabox/www/sf/download.php:79:main_wrap
                                             |download.php:98:main
                                             |download.php:304:quickFileRedir
                                             |download.php:1059:exit_service_unavailable
                                             |common/ErrorHTTP.inc:136:head
                                             |Nav.inc:155:__construct
                                             |Nav.inc:230:session_start
                                             |Cookies.inc:50:log
  4.7738   0.0001   skipping session_start, user not logged-in   petabox/www/sf/download.php:79:main_wrap
                                             |download.php:98:main
                                             |download.php:304:quickFileRedir
                                             |download.php:1059:exit_service_unavailable
                                             |common/ErrorHTTP.inc:136:head
                                             ...
                                             |Nav.inc:230:session_start
                                             |Cookies.inc:60:log
  4.7978   0.0240                                     bug dump   petabox/www/sf/download.php:79:main_wrap
                                             |download.php:98:main
                                             |download.php:304:quickFileRedir
                                             |download.php:1059:exit_service_unavailable
...
if (typeof archive_analytics !== 'undefined') {
  ...
  for (var i in vs) {
    ...
    vs[i]['server_name']="www09.us.archive.org";
          ...
          <img src="//athena.archive.org/0.gif?kind=track_js&track_js_case=control&cache_bust=470381660" alt="" />
          <noscript>
        <img src="//athena.archive.org/0.gif?kind=track_js&track_js_case=disabled&cache_bust=380789532" />
      </noscript>
          <script  nonce="5207453f7e57cbb020065f12d34f15b8" >
