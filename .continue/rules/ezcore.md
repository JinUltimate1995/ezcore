...
>
> This file is a short pointer for Continue. When anything here conflicts with
...
One active implementer per branch. Don't let multiple agents (Hermes + OpenCode + Continue) edit the same files simultaneously.
