...
The Orbit console interface uses two typefaces, both bundled here so the app
(and its tests) work fully offline — no runtime font fetching.

- **Space Grotesk** (display) — Copyright (c) Florian Karsten
...
400/500/600/700, Manrope 400/500/600/700/800.
