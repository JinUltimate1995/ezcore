// Diagnostic prints are the point of this harness (it reports each stage of
// the mGBA boot/render/save sequence when run locally).
...
void main() {
  ...
  test(
    ...
    skip: bridgeLib != null && paths.stagedCoreLib('advancebit') != null
        ? null
        : 'mGBA not built on this machine',
    () {
      final lib = _dylib('advancebit');
