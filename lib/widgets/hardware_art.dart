...
/// Product-render artwork used in the perspective core carousel.
///
/// The PNG-derived WebP keeps its transparent background, so the existing
/// carousel perspective/scroll transform moves the complete device render.
