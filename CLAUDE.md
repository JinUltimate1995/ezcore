...
>
> This file is a short pointer for Claude Code. When anything here conflicts with
...
One active implementer per branch. Don't let multiple agents (Hermes + OpenCode + Claude) edit the same files simultaneously.
