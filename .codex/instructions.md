...
>
> This file is a short pointer for Codex. When anything here conflicts with
...
One active implementer per branch. Don't let multiple agents (Hermes + OpenCode + Codex) edit the same files simultaneously.
